...
const PrivacyPolicyPage = () => {
  ...
  useEffect(() => {
    if (PrivacyPolicyData?.data?.description) {
      setEditedContent(PrivacyPolicyData.data.description);
    }
  ...
  const handleSave = () => {
    ...
    const updateData = {
      cms_id: PrivacyPolicyData.data._id, // Use the _id from the response
      title: PrivacyPolicyData.data.title, // Keep the same title
      description: editedContent,
    };

    updatePrivacyPolicy(updateData, {
      onSuccess: (response) => {
        setIsEditing(false);
  ...
  const aboutContent = PrivacyPolicyData?.data;
